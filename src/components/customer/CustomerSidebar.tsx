        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-6 border-b border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-gray-900">Copilot Admin</h1>
          ...
          <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <NavItem
              ...
              icon={<Users size={18} />}
              label="Users"
              isActive={location.pathname === '/customer/users'}
              onClick={closeSidebar}
            />
            ...
            <NavItem
              ...
              label="Analytics"
              isActive={location.pathname === '/customer/analytics'}
              onClick={closeSidebar}
            />
            <NavItem
